...
This function should only modify configuration layer settings."
  ...
  (setq-default
   ...
   dotspacemacs-additional-packages '(vue-mode jetbrains-darcula-theme elpy
		'(centered-cursor-mode :location "~/.emacs.rc/centered-cursor-mode.el")
		'(focus-mode :location "~/.eamcs.rc/focus-mode.el"))
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("iA Writer Mono S"
															 :line-spacing 1
                               :size 13.0
                               :weight normal
                               :width normal)
